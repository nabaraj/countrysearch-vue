{
  mode: 'production',
  context: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\src',
    ...
    modules: [
      'node_modules',
      'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\node_modules',
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\node_modules\\cache-loader\\dist\\cjs.js',
            options: {
              cacheDirectory: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '24e3f24e'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: 'd000c02c',
              emitWarning: false,
              emitError: false,
              eslintPath: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\node_modules\\eslint',
              formatter: undefined
            }
          }
        ]
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\public',
          to: 'C:\\resource\\vue\\country-frontend-mentor\\country-frontend-mentor\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
